...
# end
     ...
     product = Product.create!(name: "Empty one", inventory: 0, description: "This is a test description with more text than should be there.")
    product = Product.create!(name: "Product Available", inventory: 1, description: "test description.")
